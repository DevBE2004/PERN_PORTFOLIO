  ...
  return (
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mt-10">
      {techStackList.map((el) => (
        <div key={el.id} className="hover:bg-blue-400 cursor-pointer">
          <div className="flex items-center gap-2 justify-center rounded-md border border-black p-3 hover:animate-bounce">
